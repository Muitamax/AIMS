...
$radio = 0; // Initialize radio counter
...
<?php
        ...
        echo "<tbody><tr><td colspan='7'>No students found for batch: " . htmlspecialchars($batch) . "</td></tr></tbody>";
    }
    $stmt->close();
} else {
    echo "<tbody><tr><td colspan='7'>Please select a batch to display students</td></tr></tbody>";
}
?>
    </table>
